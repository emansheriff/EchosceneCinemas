...
<head>
  ...
  <meta name="description" content="EchoScene Cinema - Browse and book movie tickets online">
  <title>EchoScene Cinema</title>
  ...
  <style>
   :root {
    ...
    .genre-buttons .btn:hover,
    .genre-buttons .btn.active {
      background-color: var(--primary-color);
      border-color: var(--primary-color);
      transform: translateY(-2px);
...
/* Why EchoScene Section */
  section.text-center.text-white.container {
...
section.text-center.text-white.container h2 {
color: #ffebee;
font-weight: 700;
...
section.text-center.text-white.container h5 {
color: #f44336;
font-weight: 600;
margin-bottom: 10px;
}

section.text-center.text-white.container p {
color: #ddd;
font-size: 1rem;
line-height: 1.6;
}
@keyframes neonPulse {
  0% {
    filter: drop-shadow(0 0 2px rgb(255, 77, 77)) drop-shadow(0 0 4px rgb(255, 77, 77));
  }
  50% {
    filter: drop-shadow(0 0 10px rgb(255, 77, 77)) drop-shadow(0 0 20px rgb(255, 77, 77));
  }
  100% {
    filter: drop-shadow(0 0 2px rgb(255, 77, 77)) drop-shadow(0 0 4px rgb(255, 77, 77));
  }
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav mr-auto ml-4">
          <li class="nav-item <?php echo !isset($_GET['page']) || $_GET['page'] == 'home' ? 'active' : ''; ?>">
            <a class="nav-link" href="index.php">Home <?php echo !isset($_GET['page']) || $_GET['page'] == 'home' ? '<span class="sr-only">(current)</span>' : ''; ?></a>
          </li>
          <li class="nav-item <?php echo isset($_GET['page']) && $_GET['page'] == 'movies' ? 'active' : ''; ?>">
            <a class="nav-link" href="index.php?page=movies">Movies</a>
          </li>
          <li class="nav-item <?php echo isset($_GET['page']) && $_GET['page'] == 'showtimes' ? 'active' : ''; ?>">
            <a class="nav-link" href="index.php?page=showtimes">Showtimes</a>
          </li>
        ...
        <form class="form-inline my-2 my-lg-0 mr-3">
          <div class="input-group">
            <input id="searchInput" class="form-control" type="search" placeholder="Search movies..." aria-label="Search">
        ...
        <?php if (isset($_SESSION['user_id'])): ?>
          <div class="dropdown">
            <button class="btn btn-outline-light btn-sm dropdown-toggle" type="button" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
